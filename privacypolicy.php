<?php
	$page_title='Doctors\' Management Service, Inc. | Privacy Policy';
	include ('inc/header.inc');
 ?>
<?php
	 include ('inc/topNav.inc');
?>
<div id="screenContainer"><p></p>
	<div id="content">
    
 		<div id="pageContentStandard"><h1>Privacy Policy</h1>
        <p>This Privacy Policy governs the manner in which Doctors' Management Service collects, uses, maintains and discloses information collected from users (each, a "User") of the <a href="http://doctorsmanagementservice.org/">Doctors' Management Service, Inc.</a> website ("Site"). This privacy policy applies to the Site and all products and services offered by Doctors' Management Service.</p>
...
<p>Doctors' Management Service collects and uses Users personal information for the following purposes:
...
<p>Doctors' Management Service has the discretion to update this privacy policy at any time. When we do, we will revise the updated date at the bottom of this page. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.</p>
...
944 Washington Street Suite One South Easton, MA 02375
5082388646
PrivacyPolicy@DoctorsManagementService.org</p>

<p>This document was last updated on April 06, 2012</p>

<p>Privacy policy created by Generate Privacy Policy</p></div>
 <?php
	include ('inc/sideBar.inc');
?>
 <?php
 include ('inc/footerPrivacy.inc');
 ?>
